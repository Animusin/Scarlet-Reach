...
/datum/admins/proc/create_object(mob/user)
	...
	if (!create_object_html)
		...
		objectnames = replacetext_char(objectnames, "\"", "\\\"") // Some names have quotation marks in them, so escape them...

		create_object_html = file2text('html/create_object.html')
		create_object_html = replacetext_char(create_object_html, "null /* object types */", "\"[objectjs]\"")
		create_object_html = replacetext_char(create_object_html, "null /* object names */", "\"[objectnames]\"")
...
/datum/admins/proc/quick_create_object(mob/user)
	...
	if (!html_form)
		...
		html_form = replacetext_char(html_form, "null /* object names */", "\"[objectnames]\"")
